...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var form = new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form');
  form.init();
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.path, formData).then(function (res) {
            ...
            statusMessage.textContent = _this.message.failru;
          }).finally(function () {
            _this.clearInputs();
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, index) {
        try {
          var blockElem = btn.closest('.module__video-item').nextElementSibling;
